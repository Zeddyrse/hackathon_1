 ...
 */
final class Version20221201185410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, travel_id INT NOT NULL, country_name VARCHAR(255) NOT NULL, city_name VARCHAR(255) NOT NULL, INDEX IDX_5E9E89CBECAB15B3 (travel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
